    ...
    public class CmdPatchBoundary : IExternalCommand
    {
        ...
        */
        ...
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            ...
            List<Curve> columnCrvs = Util.Geometry.ShatterCADGeometry(uidoc, import, "COLUMN", tolerance);
            List<Curve> wallCrvs = Util.Geometry.ShatterCADGeometry(uidoc, import, "WALL", tolerance);
            List<Curve> doorCrvs = Util.Geometry.ShatterCADGeometry(uidoc, import, "DOOR", tolerance);
            List<Curve> windowCrvs = Util.Geometry.ShatterCADGeometry(uidoc, import, "WINDOW", tolerance);
